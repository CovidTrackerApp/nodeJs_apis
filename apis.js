...
app.get("/check_me/:uname", async (req, res) => {
    try {
        ...
        const query2 = await client.query("SELECT * FROM beacon_scan INNER JOIN patient_data_2 on patient_data_2.patient_key=beacon_scan.beaconid_others WHERE beacon_scan.uname=$1 AND patient_data_2.result='yes'", [uname]);
